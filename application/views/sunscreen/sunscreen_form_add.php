				...
				<div class="col-md-4 col-md-offset-4">
					...
					<form action="<?=site_url('sunscreen/process')?>" method="post">
						<div class="form-group">
							...
							<input type="text" name="nameProduct" value="<?=$row->namaProduk?>" class="form-control"
								required>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							...
							<input type="text" name="protectionGrade" value="<?=$row->protectionGrade?>"
								class="form-control" required>
						</div>
						<div class="form-group">
							<label>Rating Produk *</label>
							<input type="number" name="rating" value="<?=$row->ratingProduk?>" class="form-control"
								step="0.01" required>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							...
							<input type="number" name="recommend" value="<?=$row->usersRecommend?>" class="form-control"
								required>
						</div>
						<div class="form-group">
							<label>Persentase Users Repurchase *</label>
							<input type="number" name="repurchase" value="<?=$row->usersRepurchase?>"
								class="form-control" required>
						</div>
						<div class="form-group">
							...
							<select name="jenis" class="form-control">
								...
								<option value="<?=$data->idJenisKulit?>"
									<?=$data->idJenisKulit == $row->idJenisKulit? "selected" : null?>>
									<?=$data->jenisKulit?></option>
								<?php } ?>
							</select>
						</div>
						<div class="form-group">
							...
							<select name="asal" class="form-control">
								...
								<option value="<?=$data->idAsalBrand?>"
									<?=$data->idAsalBrand == $row->idAsalBrand? "selected" : null?>>
									<?=$data->asalBrand?></option>
								<?php } ?>
							</select>
						</div>
						<div class="form-group">
							<label>Nama Perusahaan</label>
							<input type="text" name="nameCompany" value="<?=$row->namaPerusahaan?>"
								class="form-control">
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							...
							<input type="text" name="url" value="<?=$row->link?>" class="form-control">
						</div>
						<div class="form-group">
